"""
------------- Link for the challenge: https://codeforces.com/contest/12/problem/A -----------
...
For this mission they have been preparing special agent Pearlo for many years. When, finally, Pearlo learned all
secrets of espionage, he penetrated into the Potatoland territory and reached the secret base.
...
Input
Input contains the matrix of three rows of three symbols each.
Symbol «X» means that the corresponding button was pressed, and «.» means that is was not pressed.
The matrix may contain no «X», also it may contain no «.».
...
totalReverse = total[::-1]
if total.__eq__(totalReverse):
    print("YES")
else:
    print("NO")
